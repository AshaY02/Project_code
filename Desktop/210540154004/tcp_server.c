...
Dated : Aug,28, 2021
Task:
Connects to client and receive the message and disconnects after sending the ack.
...
int main( int argc, char *argv[])
{
    ...
    while (1)
    {
        ...
        printf("Msg from Client  1st number: %d\n",num1);
        read(connfd,&num2, sizeof(num2));
        printf("Msg from Client  2nd number: %d\n",num2);
       // printf("operator +,-,*,/ : ");
        switch(operator){
	...
	default:
        ...
        write(connfd,&total, sizeof(total));
    }
